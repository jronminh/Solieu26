...
synthetic data — so decode.py/pipeline/decode.py get exercised against the actual
...
# pipeline/decode.py stitches a continuous run of hours together (missing/duplicate
